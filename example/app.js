...
var express = require('express'),
    ...
    LocatorMicro = require('../'), // require('locator-micro'), // add `locator-micro` to package.json
...
// this will signal express-view to use templates/page.micro as the layout template
app.set('layout', 'page');
...
loca.plug(new LocatorMicro({ format: 'yui' }))
